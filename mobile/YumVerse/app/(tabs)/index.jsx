  ...
  const loadData = async () => {
    try {
      ...
      const transformedCategories = apiCategories.map((cat, index) => ({
        ...
        image: `https://source.unsplash.com/600x400/?${cat.strCategory},vegetarian`,
        description: `${cat.strCategory} dishes`,
      }));
      ...
      const transformedFeatured = MealAPI.transformMealData(randomMeals[0]);
    ...
    <View style={homeStyles.container}>
      ...
      >
        ...
        <View style={homeStyles.welcomeSection}>
          <Image
            source={require("../../assets/images/food5.webp")}
            style={{
              width: 100,
              height: 100,
            }}
          />
          <Image
            source={require("../../assets/images/food4.webp")}
            style={{
              width: 100,
              height: 100,
            }}
          />
          <Image
            source={require("../../assets/images/food3.webp")}
            style={{
              width: 100,
              height: 100,
            }}
